  ...
  function matchSelector(elem, selector) {
    if ($) {
      ...
      return elementMatchesSelector.call(elem, selector);
       ...
       //On the https://github.com/luke-chang/js-spatial-navigation/blob/master/spatial_navigation.js
      ///There is en eror in the line below:
      //return selector.indexOf(elem) >= 0;    //the .indexof(...) function is not available
      //It here it has been changed to the following:
      for (let index = 0; index < selector.length; index++) {
        let item = selector[index];
